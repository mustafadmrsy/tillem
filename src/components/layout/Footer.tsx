...
export function Footer() {
  ...
  return (
    <footer className="bg-green-deep pt-20">
      <div className="h-px bg-[linear-gradient(90deg,transparent,rgba(44,74,66,0.35),rgba(44,74,66,0.8),rgba(44,74,66,0.35),transparent)]" />
      ...
      <div className="mx-auto grid max-w-[1280px] grid-cols-1 gap-12 px-6 py-16 [@media(min-width:520px)]:grid-cols-1 [@media(min-width:1024px)]:grid-cols-[1.8fr_1fr_1fr_1fr] [@media(min-width:1024px)]:gap-12 [@media(min-width:1024px)]:px-10 [@media(min-width:640px)]:grid-cols-2">
        <div>
          <Link href="/" className="flex flex-col leading-none">
            <span className="font-display text-[1.35rem] font-normal tracking-[0.1em] text-white">
              Tillem Tekstil
            </span>
            <span className="mt-1 text-[0.5rem] font-semibold uppercase tracking-[0.32em] text-[#D6E2DD]">
              Est. 1965 — Denizli, Türkiye
            </span>
          </Link>

          <p className="mt-5 text-[0.8rem] leading-[1.8] tracking-[0.03em] text-[#D6E2DD]/80">
          ...
          <div className="mt-6 flex gap-2">
            {[
              ...
              <a
                key={s.label}
                href={s.href}
                className="flex h-[34px] w-[34px] items-center justify-center rounded-sm border border-[#2C4A42] text-[0.7rem] text-[#D6E2DD]/80 transition-colors hover:border-[#D6E2DD]/60 hover:bg-white/5 hover:text-white"
              >
                {s.label}
              </a>
            ))}
        ...
        <div>
          <div className="text-[0.6rem] font-semibold uppercase tracking-[0.28em] text-white">
            {t.nav.products}
          </div>
          <ul className="mt-5 space-y-2.5">
            {[
              ...
              <li key={l.label}>
                <Link
                  href={l.href}
                  className="text-[0.78rem] tracking-[0.04em] text-[#D6E2DD]/80 transition-colors hover:text-white"
                >
                  {l.label}
                </Link>
              </li>
        ...
        <div>
          ...
          <div className="mt-5 space-y-3">
            <div className="flex gap-2 text-[0.76rem] leading-[1.6] tracking-[0.02em] text-[#D6E2DD]/80">
              <span className="mt-1 inline-flex h-3.5 w-3.5 items-center justify-center text-[#D6E2DD]">
      ...
      <div className="mx-auto flex max-w-[1280px] flex-col gap-4 border-t border-[#2C4A42] px-6 py-8 [@media(min-width:1024px)]:px-10 [@media(min-width:640px)]:flex-row [@media(min-width:640px)]:items-center [@media(min-width:640px)]:justify-between">
        <div className="text-[0.68rem] tracking-[0.06em] text-[#D6E2DD]/70">
        ...
        <div className="flex gap-6">
          {[
            ...
            <a
              key={l.label}
              href={l.href}
              className="text-[0.65rem] tracking-[0.08em] text-[#D6E2DD]/70 transition-colors hover:text-white"
            >
